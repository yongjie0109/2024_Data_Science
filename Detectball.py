...
with open('adaboost_ball_model.pkl', 'rb') as model_file:
	ball_adaboost = pickle.load(model_file)
...
def scan_callback(scan):
	global prev_y_pred, probability
	...
	y_pred = ball_adaboost.predict(test_X)
